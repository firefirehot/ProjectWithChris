...
int main(int argc, char *argv[])
{
  ...
  printf(1, "\n This program tests the correctness of your lab#2\n");
   9:	c7 44 24 04 e8 09 00 	movl   $0x9e8,0x4(%esp)
  10:	00 
...
00000030 <PScheduler>:
  ...
  a9:	7e 28                	jle    d3 <PScheduler+0xa3>
		for (i = 0; i <  4; i++) {
			wait();
  ab:	e8 da 02 00 00       	call   38a <wait>
  b0:	e8 d5 02 00 00       	call   38a <wait>
  b5:	e8 d0 02 00 00       	call   38a <wait>
  ba:	e8 cb 02 00 00       	call   38a <wait>

		}
                     printf(1,"\n if processes with highest priority finished first then its correct \n");
  bf:	c7 44 24 04 a0 09 00 	movl   $0x9a0,0x4(%esp)
  c6:	00 
  c7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  ce:	e8 fd 03 00 00       	call   4d0 <printf>
}
	exit();		
  d3:	e8 aa 02 00 00       	call   382 <exit>
	else if ( pid == 0) {
  d8:	74 1c                	je     f6 <PScheduler+0xc6>
			printf(2," \n Error \n");
  da:	c7 44 24 04 1c 0a 00 	movl   $0xa1c,0x4(%esp)
  e1:	00 
  e2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  e9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  ec:	e8 df 03 00 00       	call   4d0 <printf>
  f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  f4:	eb a9                	jmp    9f <PScheduler+0x6f>
		set_prior(40-10*i);
  f6:	6b c3 f6             	imul   $0xfffffff6,%ebx,%eax
 ...
 123:	e8 4a 02 00 00       	call   372 <get_prior>
 128:	89 c3                	mov    %eax,%ebx
 12a:	e8 d3 02 00 00       	call   402 <getpid>
 12f:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
 133:	c7 44 24 04 70 09 00 	movl   $0x970,0x4(%esp)
 13a:	00 
 13b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 142:	89 44 24 08          	mov    %eax,0x8(%esp)
 146:	e8 85 03 00 00       	call   4d0 <printf>
		exit();
 14b:	e8 32 02 00 00       	call   382 <exit>
 ...
 265:	31 f6                	xor    %esi,%esi
{
 ...
 283:	e8 12 01 00 00       	call   39a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2d6:	e8 e7 00 00 00       	call   3c2 <open>
  if(fd < 0)
 ...
 2eb:	e8 ea 00 00 00       	call   3da <fstat>
  close(fd);
 2f0:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2f3:	89 c6                	mov    %eax,%esi
  close(fd);
 2f5:	e8 b0 00 00 00       	call   3aa <close>
  return r;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 469:	0f b6 92 2e 0a 00 00 	movzbl 0xa2e(%edx),%edx
  }while((x /= base) != 0);
 ...
 4de:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 5ff:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 601:	b8 27 0a 00 00       	mov    $0xa27,%eax
 ...
 6c1:	a1 c0 0c 00 00       	mov    0xcc0,%eax
{
 ...
 707:	89 10                	mov    %edx,(%eax)
  freep = p;
 709:	a3 c0 0c 00 00       	mov    %eax,0xcc0
}
 70e:	5b                   	pop    %ebx
 70f:	5e                   	pop    %esi
 710:	5f                   	pop    %edi
 ...
 72f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 732:	a3 c0 0c 00 00       	mov    %eax,0xcc0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 1d c0 0c 00 00    	mov    0xcc0,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 799:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 79b:	3b 15 c0 0c 00 00    	cmp    0xcc0,%edx
 ...
 7f4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7f7:	89 15 c0 0c 00 00    	mov    %edx,0xcc0
      return (void*)(p + 1);
 ...
 80c:	eb e9                	jmp    7f7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 80e:	c7 05 c0 0c 00 00 c4 	movl   $0xcc4,0xcc0
 815:	0c 00 00 
    base.s.size = 0;
 818:	ba c4 0c 00 00       	mov    $0xcc4,%edx
    base.s.ptr = freep = prevp = &base;
 81d:	c7 05 c4 0c 00 00 c4 	movl   $0xcc4,0xcc4
 824:	0c 00 00 
    base.s.size = 0;
 827:	c7 05 c8 0c 00 00 00 	movl   $0x0,0xcc8
 82e:	00 00 00 
