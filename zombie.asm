 ...
 145:	31 f6                	xor    %esi,%esi
{
 ...
 163:	e8 12 01 00 00       	call   27a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1b6:	e8 e7 00 00 00       	call   2a2 <open>
  if(fd < 0)
 ...
 1cb:	e8 ea 00 00 00       	call   2ba <fstat>
  close(fd);
 1d0:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 1d3:	89 c6                	mov    %eax,%esi
  close(fd);
 1d5:	e8 b0 00 00 00       	call   28a <close>
  return r;
...
malloc(uint nbytes)
{
 ...
 69a:	e8 4b fc ff ff       	call   2ea <sbrk>
  if(p == (char*)-1)
