...
main(int argc, char *argv[])
{
  ...
  3d:	e8 40 05 00 00       	call   582 <open>
  ...
  61:	e8 04 05 00 00       	call   56a <close>
  for(i = 2; i < argc; i++){
  66:	39 75 08             	cmp    %esi,0x8(%ebp)
  69:	7f c5                	jg     30 <main+0x30>
  }
  exit();
  6b:	e8 d2 04 00 00       	call   542 <exit>
      printf(1, "grep: cannot open %s\n", argv[i]);
  ...
  85:	e8 06 06 00 00       	call   690 <printf>
      exit();
  8a:	e8 b3 04 00 00       	call   542 <exit>
    grep(pattern, 0);
  ...
  9a:	e8 61 01 00 00       	call   200 <grep>
    exit();
  9f:	e8 9e 04 00 00       	call   542 <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  ...
  b3:	e8 d8 05 00 00       	call   690 <printf>
    exit();
  b8:	e8 85 04 00 00       	call   542 <exit>
  bd:	66 90                	xchg   %ax,%ax
  bf:	90                   	nop
...
00000200 <grep>:
{
 ...
 237:	e8 1e 03 00 00       	call   55a <read>
 ...
 2a3:	e8 ba 02 00 00       	call   562 <write>
 ...
 425:	31 f6                	xor    %esi,%esi
{
 ...
 443:	e8 12 01 00 00       	call   55a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 496:	e8 e7 00 00 00       	call   582 <open>
  if(fd < 0)
 ...
 4ab:	e8 ea 00 00 00       	call   59a <fstat>
  close(fd);
 4b0:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4b3:	89 c6                	mov    %eax,%esi
  close(fd);
 4b5:	e8 b0 00 00 00       	call   56a <close>
  return r;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 66a:	e8 f3 fe ff ff       	call   562 <write>
  while(--i >= 0)
 ...
 69e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 6d3:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 6d6:	e8 87 fe ff ff       	call   562 <write>
 ...
 746:	e8 17 fe ff ff       	call   562 <write>
        putc(fd, c);
 ...
 760:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 763:	e8 fa fd ff ff       	call   562 <write>
  for(i = 0; fmt[i]; i++){
 ...
 7f0:	e8 6d fd ff ff       	call   562 <write>
        while(*s != 0){
 ...
 820:	e8 3d fd ff ff       	call   562 <write>
 ...
 870:	e8 ed fc ff ff       	call   562 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 97a:	e8 4b fc ff ff       	call   5ca <sbrk>
  if(p == (char*)-1)
