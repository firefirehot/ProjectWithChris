   ...
   5:	be 01 00 00 00       	mov    $0x1,%esi
{
  ...
  2d:	e8 60 03 00 00       	call   392 <open>
  ...
  49:	e8 2c 03 00 00       	call   37a <close>
  for(i = 1; i < argc; i++){
  4e:	3b 75 08             	cmp    0x8(%ebp),%esi
  51:	75 cd                	jne    20 <main+0x20>
  }
  exit();
  53:	e8 fa 02 00 00       	call   352 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  ...
  7e:	e8 0d 00 00 00       	call   90 <cat>
    exit();
  83:	e8 ca 02 00 00       	call   352 <exit>
  88:	66 90                	xchg   %ax,%ax
  8a:	66 90                	xchg   %ax,%ax
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  b3:	e8 ba 02 00 00       	call   372 <write>
  ...
  cf:	e8 96 02 00 00       	call   36a <read>
 ...
 10c:	e8 8f 03 00 00       	call   4a0 <printf>
    exit();
 111:	e8 3c 02 00 00       	call   352 <exit>
 ...
 235:	31 f6                	xor    %esi,%esi
{
 ...
 253:	e8 12 01 00 00       	call   36a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2a6:	e8 e7 00 00 00       	call   392 <open>
  if(fd < 0)
 ...
 2bb:	e8 ea 00 00 00       	call   3aa <fstat>
  close(fd);
 2c0:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2c3:	89 c6                	mov    %eax,%esi
  close(fd);
 2c5:	e8 b0 00 00 00       	call   37a <close>
  return r;
 ...
 4ae:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 4e3:	88 55 e2             	mov    %dl,-0x1e(%ebp)
  write(fd, &c, 1);
 4e6:	e8 87 fe ff ff       	call   372 <write>
 ...
 556:	e8 17 fe ff ff       	call   372 <write>
        putc(fd, c);
 ...
 570:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
 573:	e8 fa fd ff ff       	call   372 <write>
  for(i = 0; fmt[i]; i++){
 ...
 680:	e8 ed fc ff ff       	call   372 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 78a:	e8 4b fc ff ff       	call   3da <sbrk>
  if(p == (char*)-1)
