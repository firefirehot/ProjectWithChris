  ...
  a8:	31 db                	xor    %ebx,%ebx
{
 ...
 17d:	e8 8e 03 00 00       	call   510 <printf>
    exit();
 182:	e8 3b 02 00 00       	call   3c2 <exit>
 ...
 2a5:	31 f6                	xor    %esi,%esi
{
 ...
 2c3:	e8 12 01 00 00       	call   3da <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 316:	e8 e7 00 00 00       	call   402 <open>
  if(fd < 0)
 ...
 32b:	e8 ea 00 00 00       	call   41a <fstat>
  close(fd);
 330:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 333:	89 c6                	mov    %eax,%esi
  close(fd);
 335:	e8 b0 00 00 00       	call   3ea <close>
  return r;
