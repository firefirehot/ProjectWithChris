...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      2c:	e8 c1 3c 00 00       	call   3cf2 <open>
  ...
  exit();
     125:	e8 88 3b 00 00       	call   3cb2 <exit>
...
00000130 <iputtest>:
{
  ...
  printf(stdout, "iput test ok\n");
    ...
    exit();
     1bb:	e8 f2 3a 00 00       	call   3cb2 <exit>
    ...
    exit();
     1d5:	e8 d8 3a 00 00       	call   3cb2 <exit>
    ...
    exit();
     1ef:	e8 be 3a 00 00       	call   3cb2 <exit>
    ...
    exit();
     209:	e8 a4 3a 00 00       	call   3cb2 <exit>
...
00000210 <exitiputtest>:
{
  ...
  pid = fork();
     22b:	e8 7a 3a 00 00       	call   3caa <fork>
  if(pid < 0){
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     2a0:	e8 5b 3b 00 00       	call   3e00 <printf>
      exit();
     2a5:	e8 08 3a 00 00       	call   3cb2 <exit>
    ...
    exit();
     2bf:	e8 ee 39 00 00       	call   3cb2 <exit>
     ...
     2d4:	e8 27 3b 00 00       	call   3e00 <printf>
      exit();
     2d9:	e8 d4 39 00 00       	call   3cb2 <exit>
      printf(stdout, "mkdir failed\n");
     ...
     2ee:	e8 0d 3b 00 00       	call   3e00 <printf>
      exit();
     2f3:	e8 ba 39 00 00       	call   3cb2 <exit>
     2f8:	90                   	nop
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     351:	e8 9c 39 00 00       	call   3cf2 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3c8:	e8 e5 38 00 00       	call   3cb2 <exit>
    ...
    exit();
     3e2:	e8 cb 38 00 00       	call   3cb2 <exit>
    printf(stdout, "fork failed\n");
    ...
    exit();
     3fc:	e8 b1 38 00 00       	call   3cb2 <exit>
...
00000410 <opentest>:
{
  ...
  printf(stdout, "open test ok\n");
    ...
    exit();
     48f:	e8 1e 38 00 00       	call   3cb2 <exit>
    ...
    exit();
     4a9:	e8 04 38 00 00       	call   3cb2 <exit>
...
000004b0 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4dc:	e8 11 38 00 00       	call   3cf2 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     51b:	e8 b2 37 00 00       	call   3cd2 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     53c:	e8 91 37 00 00       	call   3cd2 <write>
  ...
  i = read(fd, buf, 2000);
     ...
     5b5:	e8 10 37 00 00       	call   3cca <read>
  if(i == 2000){
  ...
  close(fd);
     ...
     5dd:	e8 f8 36 00 00       	call   3cda <close>
  if(unlink("small") < 0){
     5e2:	c7 04 24 af 42 00 00 	movl   $0x42af,(%esp)
     5e9:	e8 14 37 00 00       	call   3d02 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     626:	e8 d5 37 00 00       	call   3e00 <printf>
      exit();
     62b:	e8 82 36 00 00       	call   3cb2 <exit>
     ...
     644:	e8 b7 37 00 00       	call   3e00 <printf>
      exit();
     649:	e8 64 36 00 00       	call   3cb2 <exit>
    ...
    exit();
     663:	e8 4a 36 00 00       	call   3cb2 <exit>
    ...
    exit();
     67d:	e8 30 36 00 00       	call   3cb2 <exit>
    ...
    exit();
     697:	e8 16 36 00 00       	call   3cb2 <exit>
    ...
    exit();
     6b1:	e8 fc 35 00 00       	call   3cb2 <exit>
...
000006c0 <writetest1>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     6ec:	e8 01 36 00 00       	call   3cf2 <open>
  if(fd < 0){
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, 512) != 512){
     719:	e8 b4 35 00 00       	call   3cd2 <write>
  ...
  if(fd < 0){
    ...
    i = read(fd, buf, 512);
     ...
     78e:	e8 37 35 00 00       	call   3cca <read>
    if(i == 0){
  ...
  close(fd);
     ...
     7a6:	e8 2f 35 00 00       	call   3cda <close>
  if(unlink("big") < 0){
     7ab:	c7 04 24 f7 43 00 00 	movl   $0x43f7,(%esp)
     7b2:	e8 4b 35 00 00       	call   3d02 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     7ef:	e8 0c 36 00 00       	call   3e00 <printf>
      exit();
     7f4:	e8 b9 34 00 00       	call   3cb2 <exit>
     ...
     811:	e8 ea 35 00 00       	call   3e00 <printf>
      exit();
     816:	e8 97 34 00 00       	call   3cb2 <exit>
     ...
     82f:	e8 cc 35 00 00       	call   3e00 <printf>
      exit();
     834:	e8 79 34 00 00       	call   3cb2 <exit>
     ...
     851:	e8 aa 35 00 00       	call   3e00 <printf>
        exit();
     856:	e8 57 34 00 00       	call   3cb2 <exit>
    ...
    exit();
     870:	e8 3d 34 00 00       	call   3cb2 <exit>
    ...
    exit();
     88a:	e8 23 34 00 00       	call   3cb2 <exit>
    ...
    exit();
     8a4:	e8 09 34 00 00       	call   3cb2 <exit>
     ...
     8b4:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  name[2] = '\0';
    ...
    fd = open(name, O_CREATE|O_RDWR);
     8f8:	e8 f5 33 00 00       	call   3cf2 <open>
    close(fd);
     8fd:	89 04 24             	mov    %eax,(%esp)
     900:	e8 d5 33 00 00       	call   3cda <close>
  for(i = 0; i < 52; i++){
  ...
  name[2] = '\0';
    ...
    unlink(name);
     ...
     930:	e8 cd 33 00 00       	call   3d02 <unlink>
  for(i = 0; i < 52; i++){
...
00000960 <dirtest>:
{
  ...
  printf(stdout, "mkdir test ok\n");
    ...
    exit();
     9eb:	e8 c2 32 00 00       	call   3cb2 <exit>
    ...
    exit();
     a05:	e8 a8 32 00 00       	call   3cb2 <exit>
    printf(stdout, "chdir .. failed\n");
    ...
    exit();
     a1f:	e8 8e 32 00 00       	call   3cb2 <exit>
    ...
    exit();
     a39:	e8 74 32 00 00       	call   3cb2 <exit>
...
00000a40 <exectest>:
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     a6a:	e8 7b 32 00 00       	call   3cea <exec>
    ...
    exit();
     a8a:	e8 23 32 00 00       	call   3cb2 <exit>
     a8f:	90                   	nop
...
00000a90 <pipe1>:
{
  ...
  if(pipe(fds) != 0){
     ...
     a9f:	e8 1e 32 00 00       	call   3cc2 <pipe>
     aa4:	85 c0                	test   %eax,%eax
     aa6:	0f 85 4e 01 00 00    	jne    bfa <pipe1+0x16a>
  pid = fork();
     aac:	e8 f9 31 00 00       	call   3caa <fork>
  if(pid == 0){
  ...
  seq = 0;
    ...
    close(fds[1]);
     ...
     acd:	e8 08 32 00 00       	call   3cda <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     aeb:	e8 da 31 00 00       	call   3cca <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ...
     b55:	e8 80 31 00 00       	call   3cda <close>
     b5a:	89 f0                	mov    %esi,%eax
{
     ...
     b8e:	e8 3f 31 00 00       	call   3cd2 <write>
    ...
    for(n = 0; n < 5; n++){
     ...
     ba4:	75 b4                	jne    b5a <pipe1+0xca>
      exit();
     ba6:	e8 07 31 00 00       	call   3cb2 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     bba:	e8 1b 31 00 00       	call   3cda <close>
    wait();
     bbf:	e8 f6 30 00 00       	call   3cba <wait>
  printf(1, "pipe1 ok\n");
    ...
    exit();
     c0e:	e8 9f 30 00 00       	call   3cb2 <exit>
    ...
    exit();
     c27:	e8 86 30 00 00       	call   3cb2 <exit>
     ...
     c3b:	e8 c0 31 00 00       	call   3e00 <printf>
        exit();
     c40:	e8 6d 30 00 00       	call   3cb2 <exit>
...
00000c50 <preempt>:
{
  ...
  pid1 = fork();
     c6d:	e8 38 30 00 00       	call   3caa <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     c80:	e8 25 30 00 00       	call   3caa <fork>
  if(pid2 == 0)
  ...
  pipe(pfds);
     ...
     c93:	e8 2a 30 00 00       	call   3cc2 <pipe>
  pid3 = fork();
     c98:	e8 0d 30 00 00       	call   3caa <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[0]);
     ...
     ca9:	e8 2c 30 00 00       	call   3cda <close>
    if(write(pfds[1], "x", 1) != 1)
     ...
     cc4:	e8 09 30 00 00       	call   3cd2 <write>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     d10:	e8 b5 2f 00 00       	call   3cca <read>
  ...
  close(pfds[0]);
     ...
     d3c:	e8 99 2f 00 00       	call   3cda <close>
  printf(1, "kill... ");
  ...
  kill(pid1);
     ...
     d58:	e8 85 2f 00 00       	call   3ce2 <kill>
  kill(pid2);
     d5d:	89 34 24             	mov    %esi,(%esp)
     d60:	e8 7d 2f 00 00       	call   3ce2 <kill>
  kill(pid3);
     d65:	89 1c 24             	mov    %ebx,(%esp)
     d68:	e8 75 2f 00 00       	call   3ce2 <kill>
  printf(1, "wait... ");
  ...
  wait();
     d81:	e8 34 2f 00 00       	call   3cba <wait>
  wait();
     d86:	e8 2f 2f 00 00       	call   3cba <wait>
     d8b:	90                   	nop
     d8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  wait();
     d90:	e8 25 2f 00 00       	call   3cba <wait>
  printf(1, "preempt ok\n");
...
00000db0 <exitwait>:
{
    ...
    if(pid){
     dc0:	74 71                	je     e33 <exitwait+0x83>
      if(wait() != pid){
     dc2:	e8 f3 2e 00 00       	call   3cba <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     dd2:	e8 d3 2e 00 00       	call   3caa <fork>
    if(pid < 0){
  ...
  printf(1, "exitwait ok\n");
     ...
     e32:	c3                   	ret    
      exit();
     e33:	e8 7a 2e 00 00       	call   3cb2 <exit>
     e38:	90                   	nop
...
00000e40 <mem>:
{
  ...
  ppid = getpid();
     e5d:	e8 d0 2e 00 00       	call   3d32 <getpid>
     e62:	89 c6                	mov    %eax,%esi
  if((pid = fork()) == 0){
     e64:	e8 41 2e 00 00       	call   3caa <fork>
    ...
    exit();
     ed4:	e8 d9 2d 00 00       	call   3cb2 <exit>
     ...
     ee6:	5d                   	pop    %ebp
    wait();
     ee7:	e9 ce 2d 00 00       	jmp    3cba <wait>
     ...
     f07:	e8 d6 2d 00 00       	call   3ce2 <kill>
      exit();
     f0c:	e8 a1 2d 00 00       	call   3cb2 <exit>
...
00000f20 <sharedfd>:
{
  ...
  pid = fork();
     f67:	e8 3e 2d 00 00       	call   3caa <fork>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     fac:	e8 21 2d 00 00       	call   3cd2 <write>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    1022:	e8 a3 2c 00 00       	call   3cca <read>
  ...
  close(fd);
    ...
    1067:	e8 6e 2c 00 00       	call   3cda <close>
  unlink("sharedfd");
    106c:	c7 04 24 a3 45 00 00 	movl   $0x45a3,(%esp)
    1073:	e8 8a 2c 00 00       	call   3d02 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    exit();
    10fb:	e8 b2 2b 00 00       	call   3cb2 <exit>
    ...
    110b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    1143:	e8 ba 2b 00 00       	call   3d02 <unlink>
    pid = fork();
    1148:	e8 5d 2b 00 00       	call   3caa <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1169:	e8 4c 2b 00 00       	call   3cba <wait>
    116e:	bf 30 00 00 00       	mov    $0x30,%edi
    1173:	e8 42 2b 00 00       	call   3cba <wait>
    1178:	e8 3d 2b 00 00       	call   3cba <wait>
    117d:	e8 38 2b 00 00       	call   3cba <wait>
    ...
    1199:	e8 54 2b 00 00       	call   3cf2 <open>
    ...
    11b3:	e8 12 2b 00 00       	call   3cca <read>
    ...
    11d9:	e8 fc 2a 00 00       	call   3cda <close>
    if(total != 12*500){
    ...
    11f0:	e8 0d 2b 00 00       	call   3d02 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1298:	e8 35 2a 00 00       	call   3cd2 <write>
    ...
    12b7:	e8 44 2b 00 00       	call   3e00 <printf>
          exit();
    12bc:	e8 f1 29 00 00       	call   3cb2 <exit>
    ...
    12d4:	e8 27 2b 00 00       	call   3e00 <printf>
      exit();
    12d9:	e8 d4 29 00 00       	call   3cb2 <exit>
      printf(1, "fork failed\n");
    ...
    12ed:	e8 0e 2b 00 00       	call   3e00 <printf>
      exit();
    12f2:	e8 bb 29 00 00       	call   3cb2 <exit>
    ...
    1306:	e8 f5 2a 00 00       	call   3e00 <printf>
        exit();
    130b:	e8 a2 29 00 00       	call   3cb2 <exit>
    ...
    1316:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    132f:	e8 76 29 00 00       	call   3caa <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1350:	e8 65 29 00 00       	call   3cba <wait>
  for(i = 0; i < N; i++){
    1355:	31 f6                	xor    %esi,%esi
    wait();
    1357:	e8 5e 29 00 00       	call   3cba <wait>
    135c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    135f:	e8 56 29 00 00       	call   3cba <wait>
    1364:	e8 51 29 00 00       	call   3cba <wait>
  name[0] = name[1] = name[2] = 0;
    ...
    13a2:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    13a5:	e8 48 29 00 00       	call   3cf2 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    13cc:	e8 09 29 00 00       	call   3cda <close>
    for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < N; i++){
    ...
    13ff:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    1402:	e8 fb 28 00 00       	call   3d02 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < N; i++){
    ...
    14b0:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    14b3:	e8 4a 28 00 00       	call   3d02 <unlink>
    ...
    14cb:	e8 30 29 00 00       	call   3e00 <printf>
            exit();
    14d0:	e8 dd 27 00 00       	call   3cb2 <exit>
    ...
    14eb:	e8 10 29 00 00       	call   3e00 <printf>
        exit();
    14f0:	e8 bd 27 00 00       	call   3cb2 <exit>
          printf(1, "create failed\n");
    ...
    1504:	e8 f7 28 00 00       	call   3e00 <printf>
          exit();
    1509:	e8 a4 27 00 00       	call   3cb2 <exit>
      printf(1, "fork failed\n");
    ...
    151d:	e8 de 28 00 00       	call   3e00 <printf>
      exit();
    1522:	e8 8b 27 00 00       	call   3cb2 <exit>
    ...
    153a:	e8 c1 28 00 00       	call   3e00 <printf>
        exit();
    153f:	e8 6e 27 00 00       	call   3cb2 <exit>
...
00001550 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    157b:	e8 72 27 00 00       	call   3cf2 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    15cf:	e8 2e 27 00 00       	call   3d02 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    15eb:	e8 02 27 00 00       	call   3cf2 <open>
  write(fd1, "yyy", 3);
  ...
  write(fd1, "yyy", 3);
    ...
    1605:	e8 c8 26 00 00       	call   3cd2 <write>
  close(fd1);
    160a:	89 34 24             	mov    %esi,(%esp)
    160d:	e8 c8 26 00 00       	call   3cda <close>
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1625:	e8 a0 26 00 00       	call   3cca <read>
  ...
  printf(1, "unlinkread ok\n");
    ...
    exit();
    169c:	e8 11 26 00 00       	call   3cb2 <exit>
    ...
    exit();
    16b5:	e8 f8 25 00 00       	call   3cb2 <exit>
    ...
    exit();
    16ce:	e8 df 25 00 00       	call   3cb2 <exit>
    ...
    exit();
    16e7:	e8 c6 25 00 00       	call   3cb2 <exit>
    ...
    exit();
    1700:	e8 ad 25 00 00       	call   3cb2 <exit>
    ...
    exit();
    1719:	e8 94 25 00 00       	call   3cb2 <exit>
...
00001720 <linktest>:
{
  ...
  fd = open("lf2", 0);
    ...
    17ed:	e8 00 25 00 00       	call   3cf2 <open>
  if(fd < 0){
  ...
  if(link(".", "lf1") >= 0){
    ...
    1874:	e8 99 24 00 00       	call   3d12 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    18ab:	e8 02 24 00 00       	call   3cb2 <exit>
    ...
    exit();
    18c4:	e8 e9 23 00 00       	call   3cb2 <exit>
    ...
    exit();
    18dd:	e8 d0 23 00 00       	call   3cb2 <exit>
    ...
    exit();
    18f6:	e8 b7 23 00 00       	call   3cb2 <exit>
    ...
    exit();
    190f:	e8 9e 23 00 00       	call   3cb2 <exit>
    ...
    exit();
    1928:	e8 85 23 00 00       	call   3cb2 <exit>
    ...
    exit();
    1941:	e8 6c 23 00 00       	call   3cb2 <exit>
    ...
    exit();
    195a:	e8 53 23 00 00       	call   3cb2 <exit>
    ...
    exit();
    1973:	e8 3a 23 00 00       	call   3cb2 <exit>
    1978:	90                   	nop
    ...
    1985:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    19ee:	83 c6 01             	add    $0x1,%esi
      wait();
    19f1:	e8 c4 22 00 00       	call   3cba <wait>
  for(i = 0; i < 40; i++){
    ...
    1a04:	e8 f9 22 00 00       	call   3d02 <unlink>
    pid = fork();
    1a09:	e8 9c 22 00 00       	call   3caa <fork>
    if(pid && (i % 3) == 1){
    ...
    1a3b:	e8 d2 22 00 00       	call   3d12 <link>
        exit();
    1a40:	e8 6d 22 00 00       	call   3cb2 <exit>
  ...
  for(i = 0; i < 40; i++){
    ...
    1a56:	e8 b7 22 00 00       	call   3d12 <link>
      wait();
    1a5b:	e8 5a 22 00 00       	call   3cba <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    1a95:	e8 58 22 00 00       	call   3cf2 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1ab7:	e8 0e 22 00 00       	call   3cca <read>
  ...
  close(fd);
    ...
    1b03:	e8 d2 21 00 00       	call   3cda <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    1b88:	83 c6 01             	add    $0x1,%esi
      wait();
    1b8b:	e8 2a 21 00 00       	call   3cba <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    1b9b:	e8 0a 21 00 00       	call   3caa <fork>
    if(pid < 0){
    ...
    1bd1:	e8 2c 21 00 00       	call   3d02 <unlink>
      unlink(file);
    1bd6:	89 1c 24             	mov    %ebx,(%esp)
    1bd9:	e8 24 21 00 00       	call   3d02 <unlink>
      unlink(file);
    1bde:	89 1c 24             	mov    %ebx,(%esp)
    1be1:	e8 1c 21 00 00       	call   3d02 <unlink>
      unlink(file);
    1be6:	89 1c 24             	mov    %ebx,(%esp)
    1be9:	e8 14 21 00 00       	call   3d02 <unlink>
  ...
  printf(1, "concreate ok\n");
    ...
    1c1b:	e8 e0 21 00 00       	call   3e00 <printf>
      exit();
    1c20:	e8 8d 20 00 00       	call   3cb2 <exit>
    ...
    1c38:	e8 c3 21 00 00       	call   3e00 <printf>
        exit();
    1c3d:	e8 70 20 00 00       	call   3cb2 <exit>
    ...
    exit();
    1c76:	e8 37 20 00 00       	call   3cb2 <exit>
    ...
    1c91:	e8 6a 21 00 00       	call   3e00 <printf>
        exit();
    1c96:	e8 17 20 00 00       	call   3cb2 <exit>
    1c9b:	90                   	nop
...
00001ca0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1cc4:	e8 39 20 00 00       	call   3d02 <unlink>
  pid = fork();
    1cc9:	e8 dc 1f 00 00       	call   3caa <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1d04:	e8 f9 1f 00 00       	call   3d02 <unlink>
  for(i = 0; i < 100; i++){
    ...
    1d38:	e8 b5 1f 00 00       	call   3cf2 <open>
    1d3d:	89 04 24             	mov    %eax,(%esp)
    1d40:	e8 95 1f 00 00       	call   3cda <close>
  for(i = 0; i < 100; i++){
  ...
  if(pid)
    ...
    wait();
    1d51:	e8 64 1f 00 00       	call   3cba <wait>
  printf(1, "linkunlink ok\n");
    ...
    1d87:	e8 86 1f 00 00       	call   3d12 <link>
    ...
    exit();
    1da5:	e8 08 1f 00 00       	call   3cb2 <exit>
    exit();
    1daa:	e8 03 1f 00 00       	call   3cb2 <exit>
    1daf:	90                   	nop
...
00001db0 <bigdir>:
{
  ...
  close(fd);
    1df9:	e8 dc 1e 00 00       	call   3cda <close>
    ...
    if(link("bd", name) != 0){
    1e31:	e8 dc 1e 00 00       	call   3d12 <link>
  ...
  unlink("bd");
    1e4f:	e8 ae 1e 00 00       	call   3d02 <unlink>
    ...
    if(unlink(name) != 0){
    1e79:	e8 84 1e 00 00       	call   3d02 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1eb7:	e8 44 1f 00 00       	call   3e00 <printf>
      exit();
    1ebc:	e8 f1 1d 00 00       	call   3cb2 <exit>
    ...
    1ed0:	e8 2b 1f 00 00       	call   3e00 <printf>
      exit();
    1ed5:	e8 d8 1d 00 00       	call   3cb2 <exit>
    ...
    exit();
    1eee:	e8 bf 1d 00 00       	call   3cb2 <exit>
...
00001f00 <subdir>:
{
  ...
  unlink("ff");
    ...
    1f22:	e8 db 1d 00 00       	call   3d02 <unlink>
  if(mkdir("dd") != 0){
    1f27:	c7 04 24 d8 49 00 00 	movl   $0x49d8,(%esp)
    1f2e:	e8 e7 1d 00 00       	call   3d1a <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1f4a:	e8 a3 1d 00 00       	call   3cf2 <open>
  if(fd < 0){
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1fb0:	e8 3d 1d 00 00       	call   3cf2 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2010:	e8 b5 1c 00 00       	call   3cca <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    20de:	e8 0f 1c 00 00       	call   3cf2 <open>
  if(fd < 0){
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2141:	e8 ac 1b 00 00       	call   3cf2 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    215d:	e8 90 1b 00 00       	call   3cf2 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2179:	e8 74 1b 00 00       	call   3cf2 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2195:	e8 58 1b 00 00       	call   3cf2 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    21b1:	e8 3c 1b 00 00       	call   3cf2 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    21cd:	e8 40 1b 00 00       	call   3d12 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    21e9:	e8 24 1b 00 00       	call   3d12 <link>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2330:	e8 7d 19 00 00       	call   3cb2 <exit>
    ...
    exit();
    2349:	e8 64 19 00 00       	call   3cb2 <exit>
    ...
    exit();
    2362:	e8 4b 19 00 00       	call   3cb2 <exit>
    ...
    exit();
    237b:	e8 32 19 00 00       	call   3cb2 <exit>
    ...
    exit();
    2394:	e8 19 19 00 00       	call   3cb2 <exit>
    ...
    exit();
    23ad:	e8 00 19 00 00       	call   3cb2 <exit>
    ...
    exit();
    23c6:	e8 e7 18 00 00       	call   3cb2 <exit>
    ...
    exit();
    23df:	e8 ce 18 00 00       	call   3cb2 <exit>
    ...
    exit();
    23f8:	e8 b5 18 00 00       	call   3cb2 <exit>
    ...
    exit();
    2411:	e8 9c 18 00 00       	call   3cb2 <exit>
    ...
    exit();
    242a:	e8 83 18 00 00       	call   3cb2 <exit>
    ...
    exit();
    2443:	e8 6a 18 00 00       	call   3cb2 <exit>
    ...
    exit();
    245c:	e8 51 18 00 00       	call   3cb2 <exit>
    ...
    exit();
    2475:	e8 38 18 00 00       	call   3cb2 <exit>
    ...
    exit();
    248e:	e8 1f 18 00 00       	call   3cb2 <exit>
    ...
    exit();
    24a7:	e8 06 18 00 00       	call   3cb2 <exit>
    ...
    exit();
    24c0:	e8 ed 17 00 00       	call   3cb2 <exit>
    ...
    exit();
    24d9:	e8 d4 17 00 00       	call   3cb2 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    ...
    exit();
    24f2:	e8 bb 17 00 00       	call   3cb2 <exit>
    ...
    exit();
    250b:	e8 a2 17 00 00       	call   3cb2 <exit>
    ...
    exit();
    2524:	e8 89 17 00 00       	call   3cb2 <exit>
    ...
    exit();
    253d:	e8 70 17 00 00       	call   3cb2 <exit>
    ...
    exit();
    2556:	e8 57 17 00 00       	call   3cb2 <exit>
    ...
    exit();
    256f:	e8 3e 17 00 00       	call   3cb2 <exit>
    ...
    exit();
    2588:	e8 25 17 00 00       	call   3cb2 <exit>
    ...
    exit();
    25a1:	e8 0c 17 00 00       	call   3cb2 <exit>
    ...
    exit();
    25ba:	e8 f3 16 00 00       	call   3cb2 <exit>
    ...
    exit();
    25d3:	e8 da 16 00 00       	call   3cb2 <exit>
    ...
    exit();
    25ec:	e8 c1 16 00 00       	call   3cb2 <exit>
    ...
    exit();
    2605:	e8 a8 16 00 00       	call   3cb2 <exit>
    ...
    exit();
    261e:	e8 8f 16 00 00       	call   3cb2 <exit>
    ...
    exit();
    2637:	e8 76 16 00 00       	call   3cb2 <exit>
    ...
    exit();
    2650:	e8 5d 16 00 00       	call   3cb2 <exit>
    ...
    exit();
    2669:	e8 44 16 00 00       	call   3cb2 <exit>
    ...
    exit();
    2682:	e8 2b 16 00 00       	call   3cb2 <exit>
    ...
    2695:	bb f3 01 00 00       	mov    $0x1f3,%ebx
{
  ...
  unlink("bigwrite");
    ...
    26ed:	e8 e0 15 00 00       	call   3cd2 <write>
      if(cc != sz){
    ...
    2705:	e8 c8 15 00 00       	call   3cd2 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2717:	e8 be 15 00 00       	call   3cda <close>
    unlink("bigwrite");
    271c:	c7 04 24 d4 4b 00 00 	movl   $0x4bd4,(%esp)
    2723:	e8 da 15 00 00       	call   3d02 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    2762:	e8 99 16 00 00       	call   3e00 <printf>
        exit();
    2767:	e8 46 15 00 00       	call   3cb2 <exit>
    ...
    277b:	e8 80 16 00 00       	call   3e00 <printf>
      exit();
    2780:	e8 2d 15 00 00       	call   3cb2 <exit>
...
00002790 <bigfile>:
{
  ...
  if(fd < 0){
    ...
    280b:	e8 c2 14 00 00       	call   3cd2 <write>
  ...
  for(i = 0; ; i++){
    ...
    2891:	e8 34 14 00 00       	call   3cca <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    289f:	90                   	nop
    28a0:	e8 35 14 00 00       	call   3cda <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    28b8:	e8 45 14 00 00       	call   3d02 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    28e8:	e8 13 15 00 00       	call   3e00 <printf>
      exit();
    28ed:	e8 c0 13 00 00       	call   3cb2 <exit>
    ...
    2901:	e8 fa 14 00 00       	call   3e00 <printf>
      exit();
    2906:	e8 a7 13 00 00       	call   3cb2 <exit>
    ...
    291a:	e8 e1 14 00 00       	call   3e00 <printf>
      exit();
    291f:	e8 8e 13 00 00       	call   3cb2 <exit>
    ...
    2933:	e8 c8 14 00 00       	call   3e00 <printf>
      exit();
    2938:	e8 75 13 00 00       	call   3cb2 <exit>
    ...
    exit();
    2951:	e8 5c 13 00 00       	call   3cb2 <exit>
    ...
    exit();
    296a:	e8 43 13 00 00       	call   3cb2 <exit>
    ...
    exit();
    2983:	e8 2a 13 00 00       	call   3cb2 <exit>
    2988:	90                   	nop
...
00002990 <fourteen>:
{
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    2a64:	e8 49 12 00 00       	call   3cb2 <exit>
    ...
    exit();
    2a7d:	e8 30 12 00 00       	call   3cb2 <exit>
    ...
    exit();
    2a96:	e8 17 12 00 00       	call   3cb2 <exit>
    ...
    exit();
    2aaf:	e8 fe 11 00 00       	call   3cb2 <exit>
    ...
    exit();
    2ac8:	e8 e5 11 00 00       	call   3cb2 <exit>
    ...
    exit();
    2ae1:	e8 cc 11 00 00       	call   3cb2 <exit>
...
00002af0 <rmdot>:
{
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    2bcc:	e8 e1 10 00 00       	call   3cb2 <exit>
    ...
    exit();
    2be5:	e8 c8 10 00 00       	call   3cb2 <exit>
    ...
    exit();
    2bfe:	e8 af 10 00 00       	call   3cb2 <exit>
    printf(1, "unlink dots/. worked!\n");
    ...
    exit();
    2c17:	e8 96 10 00 00       	call   3cb2 <exit>
    printf(1, "chdir / failed\n");
    ...
    exit();
    2c30:	e8 7d 10 00 00       	call   3cb2 <exit>
    printf(1, "rm .. worked!\n");
    ...
    exit();
    2c49:	e8 64 10 00 00       	call   3cb2 <exit>
    printf(1, "rm . worked!\n");
    ...
    exit();
    2c62:	e8 4b 10 00 00       	call   3cb2 <exit>
    ...
    exit();
    2c7b:	e8 32 10 00 00       	call   3cb2 <exit>
...
00002c80 <dirfile>:
{
  ...
  fd = open("dirfile/xx", 0);
    ...
    2ce2:	e8 0b 10 00 00       	call   3cf2 <open>
  if(fd >= 0){
  ...
  fd = open(".", O_RDWR);
    ...
    2d72:	e8 7b 0f 00 00       	call   3cf2 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2d8e:	e8 5f 0f 00 00       	call   3cf2 <open>
  if(write(fd, "x", 1) > 0){
  ...
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2de7:	e8 c6 0e 00 00       	call   3cb2 <exit>
    ...
    exit();
    2e00:	e8 ad 0e 00 00       	call   3cb2 <exit>
    ...
    exit();
    2e19:	e8 94 0e 00 00       	call   3cb2 <exit>
    ...
    exit();
    2e32:	e8 7b 0e 00 00       	call   3cb2 <exit>
    ...
    exit();
    2e4b:	e8 62 0e 00 00       	call   3cb2 <exit>
    ...
    exit();
    2e64:	e8 49 0e 00 00       	call   3cb2 <exit>
    ...
    exit();
    2e7d:	e8 30 0e 00 00       	call   3cb2 <exit>
    ...
    exit();
    2e96:	e8 17 0e 00 00       	call   3cb2 <exit>
    ...
    exit();
    2eaf:	e8 fe 0d 00 00       	call   3cb2 <exit>
    ...
    2ec4:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name OK\n");
    ...
    2fb2:	e8 49 0e 00 00       	call   3e00 <printf>
      exit();
    2fb7:	e8 f6 0c 00 00       	call   3cb2 <exit>
    ...
    2fcb:	e8 30 0e 00 00       	call   3e00 <printf>
      exit();
    2fd0:	e8 dd 0c 00 00       	call   3cb2 <exit>
    ...
    2fe4:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    3012:	e8 93 0c 00 00       	call   3caa <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    3028:	e8 8d 0c 00 00       	call   3cba <wait>
  ...
  if(wait() != -1){
    3037:	e8 7e 0c 00 00       	call   3cba <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    exit();
    3074:	e8 39 0c 00 00       	call   3cb2 <exit>
    ...
    3088:	e8 73 0d 00 00       	call   3e00 <printf>
      exit();
    308d:	e8 20 0c 00 00       	call   3cb2 <exit>
    ...
    exit();
    30a6:	e8 07 0c 00 00       	call   3cb2 <exit>
    30ab:	90                   	nop
    ...
    30b5:	31 f6                	xor    %esi,%esi
{
  ...
  pid = fork();
    3118:	e8 8d 0b 00 00       	call   3caa <fork>
  if(pid < 0){
  ...
  c = sbrk(1);
    ...
    312e:	e8 07 0c 00 00       	call   3d3a <sbrk>
  c = sbrk(1);
    3133:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    313a:	e8 fb 0b 00 00       	call   3d3a <sbrk>
  if(c != a + 1){
  ...
  wait();
    3152:	e8 63 0b 00 00       	call   3cba <wait>
  a = sbrk(0);
    3157:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    315e:	e8 d7 0b 00 00       	call   3d3a <sbrk>
  amt = (BIG) - (uint)a;
  ...
  p = sbrk(amt);
    ...
    316f:	e8 c6 0b 00 00       	call   3d3a <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    31c7:	e8 6e 0b 00 00       	call   3d3a <sbrk>
  c = sbrk(4096);
    31cc:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    31d3:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    31d5:	e8 60 0b 00 00       	call   3d3a <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    31eb:	e8 4a 0b 00 00       	call   3d3a <sbrk>
  ...
  if(c != a){
    ...
    323f:	90                   	nop
    ppid = getpid();
    3240:	e8 ed 0a 00 00       	call   3d32 <getpid>
    3245:	89 c6                	mov    %eax,%esi
    pid = fork();
    3247:	e8 5e 0a 00 00       	call   3caa <fork>
    if(pid < 0){
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    wait();
    3260:	e8 55 0a 00 00       	call   3cba <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    3273:	e8 4a 0a 00 00       	call   3cc2 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    3289:	e8 1c 0a 00 00       	call   3caa <fork>
    ...
    32af:	e8 16 0a 00 00       	call   3cca <read>
  ...
  c = sbrk(4096);
    ...
    32c5:	e8 70 0a 00 00       	call   3d3a <sbrk>
    ...
    32d6:	e8 07 0a 00 00       	call   3ce2 <kill>
    wait();
    32db:	e8 da 09 00 00       	call   3cba <wait>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3368:	e8 65 09 00 00       	call   3cd2 <write>
    336d:	8d 76 00             	lea    0x0(%esi),%esi
      for(;;) sleep(1000);
    3370:	c7 04 24 e8 03 00 00 	movl   $0x3e8,(%esp)
    3377:	e8 c6 09 00 00       	call   3d42 <sleep>
    ...
    339a:	e8 61 0a 00 00       	call   3e00 <printf>
      exit();
    339f:	e8 0e 09 00 00       	call   3cb2 <exit>
    ...
    exit();
    33b9:	e8 f4 08 00 00       	call   3cb2 <exit>
    printf(1, "pipe() failed\n");
    ...
    exit();
    33d2:	e8 db 08 00 00       	call   3cb2 <exit>
    ...
    33fa:	e8 e3 08 00 00       	call   3ce2 <kill>
      exit();
    33ff:	e8 ae 08 00 00       	call   3cb2 <exit>
      printf(stdout, "fork failed\n");
    ...
    3414:	e8 e7 09 00 00       	call   3e00 <printf>
      exit();
    3419:	e8 94 08 00 00       	call   3cb2 <exit>
    ...
    exit();
    343b:	e8 72 08 00 00       	call   3cb2 <exit>
    ...
    exit();
    3455:	e8 58 08 00 00       	call   3cb2 <exit>
    ...
    exit();
    3477:	e8 36 08 00 00       	call   3cb2 <exit>
    ...
    exit();
    3499:	e8 14 08 00 00       	call   3cb2 <exit>
    ...
    exit();
    34b3:	e8 fa 07 00 00       	call   3cb2 <exit>
    ...
    exit();
    34cd:	e8 e0 07 00 00       	call   3cb2 <exit>
    ...
    exit();
    34e7:	e8 c6 07 00 00       	call   3cb2 <exit>
    ...
    exit();
    3501:	e8 ac 07 00 00       	call   3cb2 <exit>
    ...
    3525:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(stdout, "validate ok\n");
    ...
    35bf:	e8 3c 08 00 00       	call   3e00 <printf>
      exit();
    35c4:	e8 e9 06 00 00       	call   3cb2 <exit>
...
000035d0 <bsstest>:
{
  ...
  printf(stdout, "bss test ok\n");
    ...
    363a:	e8 c1 07 00 00       	call   3e00 <printf>
      exit();
    363f:	e8 6e 06 00 00       	call   3cb2 <exit>
...
00003650 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    365d:	e8 a0 06 00 00       	call   3d02 <unlink>
  pid = fork();
    3662:	e8 43 06 00 00       	call   3caa <fork>
  if(pid == 0){
  ...
  unlink("bigarg-ok");
    ...
    36f1:	e8 f4 05 00 00       	call   3cea <exec>
    ...
    371a:	e8 d3 05 00 00       	call   3cf2 <open>
    close(fd);
    371f:	89 04 24             	mov    %eax,(%esp)
    3722:	e8 b3 05 00 00       	call   3cda <close>
    exit();
    3727:	e8 86 05 00 00       	call   3cb2 <exit>
    ...
    exit();
    3741:	e8 6c 05 00 00       	call   3cb2 <exit>
    ...
    exit();
    375b:	e8 52 05 00 00       	call   3cb2 <exit>
    ...
    3766:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    ...
    382b:	e8 c2 04 00 00       	call   3cf2 <open>
    if(fd < 0){
    ...
    3855:	e8 78 04 00 00       	call   3cd2 <write>
      if(cc < 512)
    ...
    387c:	e8 59 04 00 00       	call   3cda <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3933:	e8 ca 03 00 00       	call   3d02 <unlink>
  while(nfiles >= 0){
...
00003960 <uio>:
{
  ...
  pid = fork();
    397a:	e8 2b 03 00 00       	call   3caa <fork>
  if(pid == 0){
  ...
  wait();
    3985:	e8 30 03 00 00       	call   3cba <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    39c2:	e8 eb 02 00 00       	call   3cb2 <exit>
    printf (1, "fork failed\n");
    ...
    exit();
    39db:	e8 d2 02 00 00       	call   3cb2 <exit>
...
000039e0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    39f6:	e8 f7 02 00 00       	call   3cf2 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    3a08:	e8 2d 03 00 00       	call   3d3a <sbrk>
    ...
    3a1f:	e8 a6 02 00 00       	call   3cca <read>
  close(fd);
    3a24:	89 1c 24             	mov    %ebx,(%esp)
    3a27:	e8 ae 02 00 00       	call   3cda <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3a5a:	e8 53 02 00 00       	call   3cb2 <exit>
    3a5f:	90                   	nop
    ...
    3b95:	31 f6                	xor    %esi,%esi
{
  ...
  for(i=0; i+1 < max; ){
    ...
    3bb3:	e8 12 01 00 00       	call   3cca <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    3c06:	e8 e7 00 00 00       	call   3cf2 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3c1b:	e8 ea 00 00 00       	call   3d0a <fstat>
  close(fd);
    3c20:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    3c23:	89 c6                	mov    %eax,%esi
  close(fd);
    3c25:	e8 b0 00 00 00       	call   3cda <close>
  return r;
...
SYSCALL(set_prior)
    3c9a:	b8 16 00 00 00       	mov    $0x16,%eax
    3c9f:	cd 40                	int    $0x40
    3ca1:	c3                   	ret    

00003ca2 <get_prior>:
SYSCALL(get_prior)
    3ca2:	b8 17 00 00 00       	mov    $0x17,%eax
    3ca7:	cd 40                	int    $0x40
    3ca9:	c3                   	ret    

00003caa <fork>:
SYSCALL(fork)
    3caa:	b8 01 00 00 00       	mov    $0x1,%eax
    3caf:	cd 40                	int    $0x40
    3cb1:	c3                   	ret    

00003cb2 <exit>:
SYSCALL(exit)
    3cb2:	b8 02 00 00 00       	mov    $0x2,%eax
    3cb7:	cd 40                	int    $0x40
    3cb9:	c3                   	ret    

00003cba <wait>:
SYSCALL(wait)
    3cba:	b8 03 00 00 00       	mov    $0x3,%eax
    3cbf:	cd 40                	int    $0x40
    3cc1:	c3                   	ret    

00003cc2 <pipe>:
SYSCALL(pipe)
    3cc2:	b8 04 00 00 00       	mov    $0x4,%eax
    3cc7:	cd 40                	int    $0x40
    3cc9:	c3                   	ret    

00003cca <read>:
SYSCALL(read)
    3cca:	b8 05 00 00 00       	mov    $0x5,%eax
    3ccf:	cd 40                	int    $0x40
    3cd1:	c3                   	ret    

00003cd2 <write>:
SYSCALL(write)
    3cd2:	b8 10 00 00 00       	mov    $0x10,%eax
    3cd7:	cd 40                	int    $0x40
    3cd9:	c3                   	ret    

00003cda <close>:
SYSCALL(close)
    3cda:	b8 15 00 00 00       	mov    $0x15,%eax
    3cdf:	cd 40                	int    $0x40
    3ce1:	c3                   	ret    

00003ce2 <kill>:
SYSCALL(kill)
    3ce2:	b8 06 00 00 00       	mov    $0x6,%eax
    3ce7:	cd 40                	int    $0x40
    3ce9:	c3                   	ret    

00003cea <exec>:
SYSCALL(exec)
    3cea:	b8 07 00 00 00       	mov    $0x7,%eax
    3cef:	cd 40                	int    $0x40
    3cf1:	c3                   	ret    

00003cf2 <open>:
SYSCALL(open)
    3cf2:	b8 0f 00 00 00       	mov    $0xf,%eax
    3cf7:	cd 40                	int    $0x40
    3cf9:	c3                   	ret    

00003cfa <mknod>:
SYSCALL(mknod)
    3cfa:	b8 11 00 00 00       	mov    $0x11,%eax
    3cff:	cd 40                	int    $0x40
    3d01:	c3                   	ret    

00003d02 <unlink>:
SYSCALL(unlink)
    3d02:	b8 12 00 00 00       	mov    $0x12,%eax
    3d07:	cd 40                	int    $0x40
    3d09:	c3                   	ret    

00003d0a <fstat>:
SYSCALL(fstat)
    3d0a:	b8 08 00 00 00       	mov    $0x8,%eax
    3d0f:	cd 40                	int    $0x40
    3d11:	c3                   	ret    

00003d12 <link>:
SYSCALL(link)
    3d12:	b8 13 00 00 00       	mov    $0x13,%eax
    3d17:	cd 40                	int    $0x40
    3d19:	c3                   	ret    

00003d1a <mkdir>:
SYSCALL(mkdir)
    3d1a:	b8 14 00 00 00       	mov    $0x14,%eax
    3d1f:	cd 40                	int    $0x40
    3d21:	c3                   	ret    

00003d22 <chdir>:
SYSCALL(chdir)
    3d22:	b8 09 00 00 00       	mov    $0x9,%eax
    3d27:	cd 40                	int    $0x40
    3d29:	c3                   	ret    

00003d2a <dup>:
SYSCALL(dup)
    3d2a:	b8 0a 00 00 00       	mov    $0xa,%eax
    3d2f:	cd 40                	int    $0x40
    3d31:	c3                   	ret    

00003d32 <getpid>:
SYSCALL(getpid)
    3d32:	b8 0b 00 00 00       	mov    $0xb,%eax
    3d37:	cd 40                	int    $0x40
    3d39:	c3                   	ret    

00003d3a <sbrk>:
SYSCALL(sbrk)
    3d3a:	b8 0c 00 00 00       	mov    $0xc,%eax
    3d3f:	cd 40                	int    $0x40
    3d41:	c3                   	ret    

00003d42 <sleep>:
SYSCALL(sleep)
    3d42:	b8 0d 00 00 00       	mov    $0xd,%eax
    3d47:	cd 40                	int    $0x40
    3d49:	c3                   	ret    

00003d4a <uptime>:
SYSCALL(uptime)
    3d4a:	b8 0e 00 00 00       	mov    $0xe,%eax
    3d4f:	cd 40                	int    $0x40
    3d51:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  write(fd, &c, 1);
    ...
    3dda:	e8 f3 fe ff ff       	call   3cd2 <write>
  while(--i >= 0)
    ...
    3e0e:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  write(fd, &c, 1);
    3e46:	e8 87 fe ff ff       	call   3cd2 <write>
  ...
  write(fd, &c, 1);
    ...
    3eb6:	e8 17 fe ff ff       	call   3cd2 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    3ed3:	e8 fa fd ff ff       	call   3cd2 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    3f60:	e8 6d fd ff ff       	call   3cd2 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    3f90:	e8 3d fd ff ff       	call   3cd2 <write>
  ...
  write(fd, &c, 1);
    ...
    3fe0:	e8 ed fc ff ff       	call   3cd2 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    40ea:	e8 4b fc ff ff       	call   3d3a <sbrk>
  if(p == (char*)-1)
